...
<head>
   ...
   <title>misslo | shein</title>

   <!-- custom css file link  -->
   <link rel="stylesheet" href="css/style.css">
   <meta name="description" content="متجر الكتروني متكامل ">
   <meta name="keywords" content="متجر ايلاف ,متجر أيلاف ,متجر الكتروني ,شراء منتجات ,shein ,amazon,طلبات ">
   <link rel="icon" href="">
...
<div class="products">
   ...
   <h1 class="heading">أحدث منتجات متجر أيلاف</h1>
...
<div class="shopping-cart">
   ...
   <h1 class="heading"> عدد المنتجات</h1>
